    ...
    public class RequestItemsController : Controller
    {
        ...
        public IActionResult Create(int? itemId)
        {
            ...
            else
            {
                ...
                var item = _context.Items.FirstOrDefault(c => c.IdItem == itemId);
                ...
                var requestItem = new RequestItem
                {
                    ...
                    RequestDueDate = DateTime.Now.AddDays(10),
                ...
                //     //PicturePath=_itemViewModel.PicturePath,
                // };
                return View(requestItem);
            }
        }
        ...
        public async Task<IActionResult> Create([Bind("RequestId,OrderItemId,ItemId,UserId,CreateAt,RequestBorrowDate,RequestDueDate,NoteRequest,NoteActionRequest,Status")] RequestItemViewModel requestItem)
        {
